...
function Re(e, t) {
  let n = !1,
    ...
    a = () => (n = !0),
    o = sc.reduce((e, n) => ((e[n] = Le(a, t ? n : void 0)), e), {}),
    {
      setup: s,
      read: c,
      resolveKeyframes: l,
...
function Ue(e) {
  return (
    isNaN(e) && typeof e == `string` && (e.match(xc)?.length || 0) + (e.match(Fc)?.length || 0) > 0
  );
}
function We(e) {
  let t = e.toString(),
  ...
  return {
    ...
    split: t
      .replace(
        ...
        (e) => (
          K.test(e)
            ? (r.color.push(a), i.push(Lc), n.push(K.parse(e)))
            : e.startsWith(zc)
...
function Ke({ split: e, types: t }) {
  ...
  return (r) => {
    ...
    for (let a = 0; a < n; a++)
      if (((i += e[a]), r[a] !== void 0)) {
        let e = t[a];
        e === Ic ? (i += bc(r[a])) : e === Lc ? (i += K.transform(r[a])) : (i += r[a]);
      }
    return i;
  };
}
...
function Je(e) {
  let t = We(e);
  return Ke(t)(t.values.map((e, n) => Uc(e, t.split[n])));
}
function Ye(e, t, n) {
  return (
    n < 0 && (n += 1),
...
function ot(e) {
  let t = 0,
    n = e.next(t);
  for (; !n.done && t < Zc;) ((t += 50), (n = e.next(t)));
  return t >= Zc ? 1 / 0 : t;
}
...
function ut({
  ...
  let i, a;
  Ms(e <= L(Y.maxDuration), `Spring duration must be 10 seconds or less`, `spring-duration-limit`);
  let o = 1 - t;
...
function gt(e, t, n) {
  ...
  for (let n = 0; n < a; n++) {
    let a = i(e[n], e[n + 1]);
    (t && (a = Is(Array.isArray(t) ? t[n] || I : t, a)), r.push(a));
  }
  return r;
}
...
function Lt(
  ...
  c && (u.offset = c);
  let d = It(s, i);
  (Array.isArray(d) && (u.easing = d), z.value && dc.waapi++);
  let f = {
    delay: r,
    duration: i,
...
function fn(e, t, { delay: n = 0, transitionOverride: r, type: i } = {}) {
  ...
  for (let t in s) {
    ...
    r.start(ru(t, r, i, h && iu.has(t) ? { type: !1 } : o, e, m));
    let g = r.animation;
    g && d.push(g);
  }
  if (o) {
...
function vn(e) {
  return typeof e == `number` ? e === 0 : e === null ? !0 : e === `none` || e === `0` || Fs(e);
}
function yn(e, t, n) {
  let r = 0,
    i;
  for (; r < e.length && !i;) {
    let t = e[r];
    (typeof t == `string` && !Tu.has(t) && We(t).values.length && (i = e[r]), r++);
  }
  ...
  let [r, i, a] = wn(e, n),
    o = (e) => {
      ...
      let a = t(r, e),
        ...
        s = (e) => {
          o(e, r === f || r === document || n.useGlobalTarget || Au(r, e.target));
        },
        c = (e) => {
          o(e, !1);
        };
...
function $n(e) {
  return Zn(e.animate) || Zu.some((t) => Qn(e[t]));
}
function er(e) {
...
function Dr(e) {
  for (let t in e) ((fd[t] = e[t]), pc(t) && (fd[t].isCSSVariable = !0));
}
...
function Pr(e, t, n, r) {
  for (let n in (Tr(e, t, void 0, r), t.attrs)) e.setAttribute(vd.has(n) ? n : ln(n), t.attrs[n]);
}
function Fr(e, t, n) {
  let r = kr(e, t, n);
  for (let n in e)
...
function ti(e, t, n, r) {
  (ei(e.x, t, Ad, n ? n.x : void 0, r ? r.x : void 0),
    ei(e.y, t, jd, n ? n.y : void 0, r ? r.y : void 0));
}
function ni(e) {
...
function di(e, t, n, r, i, a) {
  i
    ? ((e.opacity = J(0, n.opacity ?? 1, Id(r))), (e.opacityExit = J(t.opacity ?? 1, 0, Ld(r))))
  ...
  for (let i = 0; i < Nd; i++) {
    ...
    (o === void 0 && s === void 0) ||
      ...
      (s ||= 0),
      o === 0 || s === 0 || Fd(o) === Fd(s)
        ? ((e[a] = Math.max(J(Pd(o), Pd(s), r), 0)), (W.test(s) || W.test(o)) && (e[a] += `%`))
        : (e[a] = s));
  }
  ...
  return class {
    constructor(e = {}, n = t?.()) {
      ((this.id = Gd++),
        ...
        (this.updateProjection = () => {
          ((this.projectionUpdateScheduled = !1),
            z.value && (Hd.nodes = Hd.calculatedTargetDeltas = Hd.calculatedProjections = 0),
            this.nodes.forEach(Ci),
            this.nodes.forEach(Mi),
            this.nodes.forEach(Ni),
            this.nodes.forEach(wi),
            z.addProjectionMetrics && z.addProjectionMetrics(Hd));
        }),
    ...
    resolveTargetDelta(e = !1) {
      ...
      (a &&
        ...
        !(!this.relativeTarget && !this.targetDelta) &&
          ...
          z.value && Hd.calculatedTargetDeltas++));
    }
    ...
    calcProjection() {
      ...
      (!this.projectionDelta || !this.prevProjectionDelta
        ...
        z.value && Hd.calculatedProjections++);
    }
    hide() {
      this.isVisible = !1;
    }
        ...
        (this.pendingAnimation = B.update(() => {
          ((Vd.hasAnimatedSinceResize = !0),
            ...
            (this.currentAnimation = mi(this.motionValue, [0, 1e3], {
              ...
              onComplete: () => {
                (dc.layout--, e.onComplete && e.onComplete(), this.completeAnimation());
              },
            })),
...
function ga(e, t, r, i) {
  let a = n(() => {
    let n = _f();
    return (Nr(n, t, yd(i), e.transformTemplate, e.style), { ...n.attrs, style: { ...n.style } });
  }, [t]);
  if (e.style) {
    let t = {};
...
function io(e, t, n, r) {
  ...
  let l = r - c;
  i.velocity = l > ep ? 0 : zs(i.current - s, l);
}
function ao(e, t, n) {
...
function yo(e) {
  ...
  for (let [t, n] of mp) if (vo(e, t)) return { rangeStart: `${n} 0%`, rangeEnd: `${n} 100%` };
}
function bo(e) {
  let t = { value: 0 };
  return {
...
function Oo(e, t) {
  return f === void 0 ? !1 : e ? Ml() && !!yo(t) : jl();
}
...
function Mo(e) {
  ((su.current = []), e());
  let t = jo(su.current, e);
  return ((su.current = void 0), t);
}
function No(e, t, n, r) {
      ...
      _ = (e, n, r, o = 0, s = 0) => {
        ...
        if (
          ...
          m &&
            Ms(
              m < xp,
              `Sequence segments can't repeat ${m} times \u2014 ignoring repeat option. Use a value below ${xp} or apply repeat at the sequence level instead.`
            ),
          m && m < xp)
        ) {
          let e = b > 0 ? _ / b : 0;
...
function ys({ children: e, as: t = `ul`, axis: n = `y`, onReorder: r, values: a, ...o }, s) {
  let l = M(() => Qf[t]),
    u = [],
    d = i(!1),
    f = i(null);
...
function Ts(e, t, n, r) {
  ...
  let i = Cs(e, n);
  if (!i) return;
  let { amount: a, edge: o } = ws(t - (n === `x` ? f.scrollX : f.scrollY), i, n);
  if (o === null) {
...
function Ds(
  ...
  let l = M(() => Qf[r]),
    u = y(kp),
    d = { x: Es(t.x), y: Es(t.y) },
    f = No([d.x, d.y], ([e, t]) => (e || t ? 1 : `unset`));
  P(!!u, `Reorder.Item must be a child of Reorder.Group`, `reorder-item-child`);
  let { axis: p, registerItem: h, updateOrder: g, groupRef: _ } = u;
  return m(l, {
    drag: p,
    ...s,
    dragSnapToOrigin: !0,
    ...
    onDrag: (e, t) => {
      ...
      (g(n, d[p].get(), r[p]), Ts(_.current, a[p], p, r[p]), i && i(e, t));
    },
    onDragEnd: (e, t) => {
      (xs(), a && a(e, t));
    },
...
var Os,
  ...
  Rp = t(() => {
    (o(),
      ...
      (oc = (e) => {
        if (rc(e)) {
          ...
          return (P(ic[e] !== void 0, `Invalid easing type '${e}'`, `invalid-easing-type`), ic[e]);
        return e;
      }),
      ...
      (dc = { layout: 0, mainThread: 0, waapi: 0 }),
      ...
      (Oc = { test: Cc(`#`), parse: He, transform: Dc.transform }),
      (kc = (e) => ({
      ...
      (K = {
        test: (e) => Dc.test(e) || Oc.test(e) || Pc.test(e),
        parse: (e) => (Dc.test(e) ? Dc.parse(e) : Pc.test(e) ? Pc.parse(e) : Oc.parse(e)),
        transform: (e) =>
          typeof e == `string` ? e : e.hasOwnProperty(`red`) ? Dc.transform(e) : Pc.transform(e),
        getAnimatableNone: (e) => {
          let t = K.parse(e);
      ...
      (Hc = (e) => (typeof e == `number` ? 0 : K.test(e) ? K.getAnimatableNone(e) : e)),
      ...
      (al = { decay: ht, inertia: ht, tween: St, keyframes: St, spring: pt }),
      (ol = class {
        constructor() {
          this.updateFinished();
        }
      ...
      (cl = class extends ol {
        ...
        initAnimation() {
          ...
          s !== St &&
            typeof o[0] != `number` &&
            ((this.mixKeyframes = Is(sl, at(o[0], o[1]))), (o = [0, 100]));
      ...
      (Ol = class {
        ...
        scheduleResolve() {
          ((this.state = `scheduled`),
            this.isAsync
              ? (wl.add(this), Tl || ((Tl = !0), B.read(Mt), B.resolveKeyframes(jt)))
      ...
      (Ll = { anticipate: Ys, backInOut: Js, circInOut: Qs }),
      (Rl = 10),
      (zl = class extends Il {
        constructor(e) {
          (Vt(e),
        ...
        updateMotionValue(e) {
          ...
          let o = new cl({ ...a, autoplay: !1 }),
            s = Math.max(Rl, U.now() - this.startTime),
            c = N(0, Rl, s - Rl),
            l = o.sample(s).value,
            { name: u } = this.options;
          (i && u && Pt(i, u, l),
      ...
      (Kl = class extends ol {
        constructor({
          ...
          ((this.keyframeResolver = new (l?.KeyframeResolver || Ol)(
            o,
      ...
      (tu = (e, { keyframes: t }) =>
        t.length > 2 ? $l : yl.has(e) ? (e.startsWith(`scale`) ? Ql(t[1]) : Zl) : eu),
      (nu = new Set([
        `when`,
        `delay`,
        `delayChildren`,
      ...
      (ru =
        ...
        (o) => {
          ...
          return s.isSync ? new cl(u) : new Kl(u);
        }),
      (iu = new Set([`width`, `height`, `top`, `left`, `right`, `bottom`, ...vl])),
      (au = 30),
      (ou = (e) => !isNaN(parseFloat(e))),
      (su = { current: void 0 }),
      (cu = class {
        constructor(e, t = {}) {
        ...
        setCurrent(e) {
          ((this.current = e),
            ...
            this.canTrackVelocity === null &&
              e !== void 0 &&
              (this.canTrackVelocity = ou(this.current)));
        }
        ...
        getVelocity() {
          let e = U.now();
          if (!this.canTrackVelocity || this.prevFrameValue === void 0 || e - this.updatedAt > au)
            return 0;
          let t = Math.min(this.updatedAt - this.prevUpdatedAt, au);
      ...
      (du = `data-` + ln(uu)),
      (fu = (e) => (t) => t.test(e)),
      (pu = [_c, G, W, Ac, Mc, jc, { test: (e) => e === `auto`, parse: (e) => e }]),
      (mu = (e) => pu.find(fu(e))),
      (hu = {
        rotate: Ac,
        rotateX: Ac,
      ...
      (Eu = class extends Ol {
        ...
        readKeyframes() {
          ...
          if (a !== o)
            ...
            else Cl[n] && (this.needsMeasurement = !0);
        }
        ...
        measureInitialState() {
          ...
          (n === `height` && (this.suspendedScrollY = f.pageYOffset),
            (this.measuredOrigin = Cl[n](e.measureViewportBox(), f.getComputedStyle(e.current))),
        ...
        measureEndState() {
          ...
          let i = n.length - 1,
            a = n[i];
          ((n[i] = Cl[t](e.measureViewportBox(), f.getComputedStyle(e.current))),
      ...
      (Z = { x: !1, y: !1 }),
      (Au = (e, t) => (t ? (e === t ? !0 : Au(e, t.parentElement)) : !1)),
      (ju = (e) =>
        e.pointerType === `mouse`
          ...
          ((this.current = e),
            ...
            this.reducedMotionConfig === `never`
              ...
              : this.reducedMotionConfig === `always`
                ...
                : ($u.current || nr(), (this.shouldReduceMotion = Qu.current)),
      ...
      (pd = class extends id {
        ...
        readValueFromInstance(e, t) {
          if (yl.has(t)) return this.projection?.isProjecting ? Dt(t) : _l(e, t);
          {
            let n = Ar(e),
      ...
      (bd = class extends id {
        ...
        readValueFromInstance(e, t) {
          ...
          return ((t = vd.has(t) ? t : ln(t)), e.getAttribute(t));
        }
        scrapeMotionValuesFromProps(e, t, n) {
          return Fr(e, t, n);
        }
      ...
      (Jd = qd(`applewebkit/`) && !qd(`chrome/`) ? Math.round : I),
      (Yd = bi({
      ...
      (ef = ({
        ...
        return (
          ...
          m(js.Provider, { value: g, children: e })
        );
      }),
      (tf = (e) => e.key || ``),
      (nf = ({
    ...
    ((pf = a({})),
      ...
      (Df = (e, t) => Math.abs(e - t)),
      (Of = (e, t) => ((t.isSVG ?? _a(e)) ? new bd(t) : new pd(t, { allowProjection: e !== l }))),
      ...
      (Pf = class {
        ...
        startAxisValueAnimation(e, t) {
          ...
          return (cn(this.visualElement, e), n.start(ru(e, n, 0, t, this.visualElement, !1)));
        }
        stopAnimation() {
      ...
      (yp = class extends cu {
        ...
        add(e) {
          (yl.has(e) || Bl.has(e)) && ((this.isEnabled = !0), this.update());
        }
        update() {
...
//# sourceMappingURL=motion.DDMpzqrG.mjs.map
