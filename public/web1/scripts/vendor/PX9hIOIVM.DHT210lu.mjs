...
import { S as m, a as h, r as te, t as ne } from "./motion.DDMpzqrG.mjs";
import {
  B as g,
  M as _,
  Q as re,
...
var T,
  ...
  pe = e(() => {
    (d(),
      ...
      (P = c((e, t) => {
        ...
        return n ? s(m.div, { ...a, layoutId: r, ref: t }) : s(`div`, { ...a, ref: t });
      })),
  ...
  me = e(() => {
    (d(),
      g(),
      n(),
      (R = `url('data:image/svg+xml,<svg display="block" role="presentation" viewBox="0 0 12 20" xmlns="http://www.w3.org/2000/svg"><path d="M 0 0 L 12 0 L 12 6 L 6 6 Z M 0 6 L 6 6 L 12 12 L 6 12 L 6 18 L 0 12 Z" fill="var(--1bd4d3i, rgb(0, 0, 0))" height="18px" id="td4SVg2I8" transform="translate(0 1.5)" width="12px"/></svg>'), var(--framer-icon-mask, none)`),
      (z = `alpha, var(--framer-icon-mask-mode, add)`),
      (B = `no-repeat`),
      (V = `center`),
      (H = `auto`),
      (U = c((e, t) => {
      ...
      (W = ({ fill: e, fill2: t, height: n, id: r, width: i, ...a }) => ({
        ...a,
        vtL2DrqsL: t ?? a.vtL2DrqsL ?? `rgb(0, 0, 0)`,
        Z1QnXqTEb: e ?? a.Z1QnXqTEb ?? `rgb(0, 0, 0)`,
      })),
      (G = S(
        ...
        [
          `.framer-hcsc7 { -webkit-mask-image: ${R}; -webkit-mask-position: ${V}; -webkit-mask-repeat: ${B}; -webkit-mask-size: ${H}; aspect-ratio: 0.6; background-color: var(--1bd4d3i); mask-image: ${R}; mask-mode: ${z}; mask-position: ${V}; mask-repeat: ${B}; mask-size: ${H}; width: 12px; }`,
        ],
        `framer-hcsc7`
      )),
      (G.displayName = `Framer`),
      (K = G),
      w(G, {
        Z1QnXqTEb: { defaultValue: `rgb(0, 0, 0)`, hidden: !1, title: `Fill`, type: x.Color },
        vtL2DrqsL: { defaultValue: `rgb(0, 0, 0)`, hidden: !0, title: `Fill 2`, type: x.Color },
...
e(() => {
  (d(),
    ...
    (q = _(K)),
    (J = _(L)),
    (Y = y(L, { nodeId: `pBR1Ew0r8`, override: de, scopeId: `PX9hIOIVM` })),
    (X = oe(ie(y(m.a, { nodeId: `HK2sXlagE`, override: ue, scopeId: `PX9hIOIVM` })))),
    (he = `framer-6jWyo`),
    ...
    (Se = ({ value: e, children: n }) => {
      ...
      return s(h.Provider, { value: a, children: n });
    }),
    (Z = m.create(a)),
        ...
        let { style: l, className: d, layoutId: f, variant: p, ...h } = Ce(e),
          {
            ...
            setVariant: oe,
            variants: x,
          } = ae({ defaultVariant: `HK2sXlagE`, ref: i, variant: p, variantClassNames: ge }),
          S = we(e, x),
          w = C(he);
        return s(te, {
          id: f ?? a,
            ...
            children: s(Se, {
              ...
              children: s(ce, {
                ...
                children: u(X, {
                  ...
                  __targetOpacity: 1,
                  className: `${C(w, `framer-n0ccwk`, d, g)} framer-bmpgw8`,
    ...
    v(Q, [{ explicitInter: !0, fonts: [] }, ...q, ...J], { supportsExplicitInterCodegen: !0 }),
    ($ = {
      exports: {
...
//# sourceMappingURL=PX9hIOIVM.DHT210lu.mjs.map
