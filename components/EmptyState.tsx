      ...
      {action && (
        <div className="pt-3">
          <motion.button
            ...
            className="h-12 px-5 rounded-2xl bg-black text-white dark:bg-white dark:text-black font-extrabold text-sm shadow-md transition-all flex items-center gap-2 cursor-pointer"
          >
