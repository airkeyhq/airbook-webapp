...
export const NotificationCenterPopover: React.FC = () => {
  ...
  return (
    <div ref={containerRef} className="relative z-[99999]">
      {/* Bell Button Pill */}
      <button
        type="button"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 mt-2 w-80 sm:w-96 glass-panel bg-white/95 dark:bg-[#141720]/95 rounded-3xl shadow-2xl p-4 z-[99999] stack-3 overflow-hidden"
          >
            {/* Popover Header */}
